                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="brand" id="brand">
                                ...
                                @isset($cData->brand )
                                    @foreach($cData->brand as $category)
                                        <option value="{{$category->id}}"
                                                @if(!empty($cData->data) && $cData->data->brand == $category->id) selected @endif>{{$category->title}}</option>

                                        @if(count($category->childs) && $category->parent_id != 43)
                                            @php $padding = " "; @endphp
